...
solution = RELOG.solve("/projects/pvsoiling/RELOG/20230301_CASE0_v3/input/solver/case.json", optimizer=gurobi)

# Write CSV report showing plant costs, capacities, energy expenditure and
# utilization factors
tick()
RELOG.write_plants_report(solution, "/projects/pvsoiling/RELOG/20230301_CASE0_v3/output/solver/plants.csv")
tock()
...
tick()
RELOG.write_transportation_report(solution, "/projects/pvsoiling/RELOG/20230301_CASE0_v3/output/solver/transportation.csv")
tock()
# Write CSV report showing primary product amounts, locations and marginal costs
tick()
RELOG.write_products_report(solution, "/projects/pvsoiling/RELOG/20230301_CASE0_v3/output/solver/products.csv");
tock()
